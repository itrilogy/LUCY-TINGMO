...
fn initialize_core_logic(app_handle: &AppHandle) {
    ...
    // L2 default punctuator (heuristic until ONNX/sherpa punc is registered).
    crate::text_punctuate::ensure_default_punctuator();
    ...
    app_handle.manage(Arc::new(session::SessionHub::new()));
    ...
    let tray = tray_builder
        .on_menu_event(|app, event| match event.id.as_ref() {
            ...
            "check_updates" => {
                // Lab: tray item is permanently disabled; no-op if invoked.
            }
...
pub fn run(cli_args: CliArgs) {
    ...
    let specta_builder = Builder::<tauri::Wry>::new()
        .commands(collect_commands![
            ...
            shortcut::change_asr_markers_rule_enabled_setting,
            shortcut::change_asr_markers_inject_glossary_setting,
            shortcut::change_asr_markers_auto_accept_new_setting,
            ...
            shortcut::open_prompts_folder,
            shortcut::export_prompts_to_folder,
            ...
            commands::transcription::copy_text_to_clipboard,
            commands::transcription::paste_text_to_frontmost,
            commands::transcription::dismiss_overlay,
            commands::markers::get_asr_marker_store,
            commands::markers::save_asr_marker_store,
            commands::markers::add_asr_marker,
            commands::markers::remove_asr_marker,
            commands::markers::accept_pending_asr_markers,
            commands::markers::set_asr_marker_confidence,
            commands::markers::clear_asr_marker_cache,
            commands::markers::get_asr_markers_file_path,
            commands::markers::import_asr_markers_markdown,
            commands::markers::export_asr_markers_markdown,
            commands::markers::export_asr_markers_markdown_file,
            commands::markers::correct_asr_word,
        ...
        .events(collect_events![
            ...
            managers::transcription::SessionProgressEvent,
            managers::transcription::SessionResultEvent,
        ]);
