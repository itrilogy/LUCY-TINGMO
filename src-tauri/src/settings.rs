...
pub struct AppSettings {
    ...
    pub asr_markers_rule_enabled: bool,
    /// Inject marker glossary into post-process prompts (`${glossary}`).
    #[serde(default = "default_true")]
    pub asr_markers_inject_glossary: bool,
    ...
    #[serde(default)]
    pub asr_markers_auto_accept_new: bool,
    /// Semi-realtime / segment display punctuation (L1 rules, optional L2 local punc).
    #[serde(default)]
    pub text_punctuation_mode: TextPunctuationMode,
...
fn default_update_checks_enabled() -> bool {
    // Lab build: updates disabled by default (footer / tray stay grayed).
    false
}
...
fn default_post_process_prompts() -> Vec<LLMPrompt> {
    vec![
        ...
        LLMPrompt {
            id: "default_asr_domain_correct".to_string(),
            name: "ASR Domain Correction".to_string(),
            prompt: crate::markers::default_asr_correction_prompt(),
        },
    ]
}
...
fn ensure_post_process_defaults(settings: &mut AppSettings) -> bool {
    ...
    // Ensure built-in ASR correction prompt exists for upgraded installs.
    if !settings
        .post_process_prompts
        .iter()
        .any(|p| p.id == "default_asr_domain_correct")
    {
...
pub fn get_default_settings() -> AppSettings {
    ...
    AppSettings {
        ...
        asr_markers_rule_enabled: true,
        asr_markers_inject_glossary: true,
        asr_markers_auto_accept_new: false,
        // LocalPunc: live uses L1+L2; batch/history uses pure ASR then L2.
        text_punctuation_mode: TextPunctuationMode::LocalPunc,
