...
const UpdateChecker: React.FC<UpdateCheckerProps> = ({ className = "" }) => {
  ...
  // Lab: force-disable auto/manual update UI (grayed out).
    ...
    <>
      ...
      <div className={`flex items-center gap-3 ${className}`}>
        {isUpdateClickable ? (
          ...
          <span
            className="text-text/35 tabular-nums cursor-not-allowed select-none"
            title={t("footer.updateCheckingDisabled")}
            aria-disabled="true"
          >
            {getUpdateStatusText()}
          </span>
