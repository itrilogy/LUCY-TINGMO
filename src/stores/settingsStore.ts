...
const settingUpdaters: {
  ...
  asr_markers_rule_enabled: (value) =>
    commands.changeAsrMarkersRuleEnabledSetting(value as boolean),
  asr_markers_inject_glossary: (value) =>
    commands.changeAsrMarkersInjectGlossarySetting(value as boolean),
  asr_markers_auto_accept_new: (value) =>
    commands.changeAsrMarkersAutoAcceptNewSetting(value as boolean),
